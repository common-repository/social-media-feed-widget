...
```
cd existing_repo
git remote add origin https://git.logicwind.co/logicwind/instaplug/insta-plug-wordpress-plugin.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.logicwind.co/logicwind/instaplug/insta-plug-wordpress-plugin/-/settings/integrations)
...
- **Terms of Use**: [Link to Terms of Use](https://instaplug.app/terms-conditions)
